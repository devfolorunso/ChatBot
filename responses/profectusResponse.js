      ...
      body: [
      ...
      
        {
          ...
          facts: [
            {
              title: "Amount",
              value:"${if(Amount==null, 'N/A', Amount)}",
            },
            {
              title: "Status",
              value:"${if(Status==null, 'N/A', Status)}",
            },
            {
              title: "TransactionDate",
              value:"${if(TransactionDate==null, 'N/A', TransactionDate)}",
            },
            {
              title: "BeneficiaryAccount",
              value:"${if(BeneficiaryAccount==null, 'N/A', BeneficiaryAccount)}",

            },
            {
              title: "BeneficiaryName",
              value: "${if(BeneficiaryName==null, 'N/A', BeneficiaryName)}",
            },
            {
              title: "BeneficiaryBankCode",
              value:"${if(BeneficiaryBankCode==null, 'N/A', BeneficiaryBankCode)}",
            },
            {
              title: "OriginatorNumber",
              value: "${if(OriginatorNumber==null, 'N/A', OriginatorNumber)}",
            },
            {
              title: "OriginatorName",
              value:  "${if(OriginatorName==null, 'N/A', OriginatorName)}",
            },
          ],
        },
      ],
